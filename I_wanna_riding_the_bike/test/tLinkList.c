...
int main(){
    ...
    ADD_TEST_TRUE("test inner data", *((int*)root->data), a);
    ...
    ADD_TEST_TRUE("test inner data after remove", *((int*)root->data), a);
    ...
    while(1){
        ...
        LinkList_Add2Head(&root, &a);
        LinkList_Add2Tail(&root, &b);
        LinkList_Destroy(&root);
    }
    return 0;
}